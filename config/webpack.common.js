...
module.exports = function (options) {
  ...
  const entry = {
    'polyfills': `./src/apps/${projectName}/polyfills.browser.ts`,
    'main':      AOT ? `./src/apps/${projectName}/main.browser.aot.ts` :
      `./src/apps/${projectName}/main.browser.ts`

  }
  const indexHtmlPath = `src/apps/${projectName}/index.html`
  return {
    ...
    module: {
      ...
      rules: [
         ...
         */
        {
          test: /\.html$/,
          use: 'raw-loader',
          exclude: [helpers.root(indexHtmlPath)]
        },
